...
public class FeatureWeatherDB {
     ...
     * 数据库名
     */
    private static final String DB_NAME="feature_weather";
    ...
    private FeatureWeatherDB(Context context){
        ...
        FeatureWeatherOpenHelper dbHelper=new FeatureWeatherOpenHelper(context, DB_NAME, null, VERSION);
        db = dbHelper.getWritableDatabase();

    }

    /**
     *   获取featureWeatherDB的实例。
     */
    ...
    public List<County> loadCounties(int cityId) {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                county.setCityId(cityId); list.add(county);
            } while (cursor.moveToNext());
        }
        return list;
    }
